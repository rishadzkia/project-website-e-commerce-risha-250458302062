<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
	...
	<form wire:submit.prevent='placeOrder'>
		...
		<div class="md:col-span-12 lg:col-span-8 col-span-12">
			...
			<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
				...
				<ul class="grid w-full gap-6 md:grid-cols-2">
					<li>
						<input wire:model='payment_method' class="hidden peer" id="hosting-small" required="" type="radio" value="hosting-small" />
		...
		<div class="md:col-span-12 lg:col-span-4 col-span-12">
			...
			{{-- [00:08:24] Ganti tombol standar --}}
			<button type="submit"
				wire:loading.attr="disabled"
				class="bg-green-500 mt-4 w-full p-3 rounded-lg text-lg text-white hover:bg-green-600 disabled:opacity-70 flex items-center justify-center gap-2">

				{{-- [00:08:59] Teks ini akan hilang saat loading --}}
				<span wire:loading.remove>
					Place Order
				</span>

				{{-- [00:08:37] Teks ini akan muncul saat loading --}}
